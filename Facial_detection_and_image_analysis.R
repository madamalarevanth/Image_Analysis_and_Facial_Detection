...
#get the api key and endpoint url from the resource created on azure cloud

api_key = "cb7c9b09576c4d14a02cef87620fac15"

api_endpoint_url = "https://centralindia.api.cognitive.microsoft.com/vision/v1.0/analyze"
...
reqURL = paste(api_endpoint_url,"?visualFeatures=",visualFeatures,
               "&details=",details,sep="")

APIresponse = POST(url = reqURL,content_type('application/json'),
...
#to get the descriptions returned are 
